...
module DocuSign_Maestro
  class DSDoUntilStep
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'doSteps')
        if (value = attributes[:'doSteps']).is_a?(Array)
          self.do_steps = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @do_steps.nil?
        invalid_properties.push('invalid value for "do_steps", do_steps cannot be nil.')
      end
    ...
    def hash
      [do_steps, expression, id, name, type].hash
    end
