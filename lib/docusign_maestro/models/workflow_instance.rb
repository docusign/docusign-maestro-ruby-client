...
module DocuSign_Maestro
  ...
  class WorkflowInstance
    ...
    def list_invalid_properties
      ...
      if @instance_state.nil?
        invalid_properties.push('invalid value for "instance_state", instance_state cannot be nil.')
      end
    ...
    def hash
      [account_id, creator_id, dac_id, end_date, instance_name, instance_state, progress, start_date, started_by, template_id, users].hash
    end
