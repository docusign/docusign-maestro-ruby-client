...
module DocuSign_Maestro
  ...
  class DSWorkflowTrigger
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'httpType')
        self.http_type = attributes[:'httpType']
      end
    ...
    def list_invalid_properties
      ...
      if @http_type.nil?
        invalid_properties.push('invalid value for "http_type", http_type cannot be nil.')
      end
    ...
    def hash
      [event_type, http_type, id, input, name, output, type].hash
    end
