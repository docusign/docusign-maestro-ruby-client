...
module DocuSign_Maestro
  class DSWorkflowReplaceExpression
    ...
    def list_invalid_properties
      ...
      if @new_text.nil?
        invalid_properties.push('invalid value for "new_text", new_text cannot be nil.')
      end

      if @old_text.nil?
        invalid_properties.push('invalid value for "old_text", old_text cannot be nil.')
      end
    ...
    def valid?
      return false if @new_text.nil?
      return false if @old_text.nil?
    ...
    def hash
      [new_text, old_text, text, type].hash
    end
