...
module DocuSign_Maestro
  class DSLoopStep
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'loopSteps')
        if (value = attributes[:'loopSteps']).is_a?(Array)
          self.loop_steps = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @loop_steps.nil?
        invalid_properties.push('invalid value for "loop_steps", loop_steps cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @loop_steps.nil?
    ...
    def hash
      [expression, id, loop_steps, name, type].hash
    end
