...
module DocuSign_Maestro
  class DSDocGenStepInput
    ...
    attr_accessor :output_file_name_is_unique
    ...
    def self.swagger_types
      {
        ...
        :'output_file_name_is_unique' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dataJson')
        self.data_json = attributes[:'dataJson']
      end

      if attributes.has_key?(:'outputFileName')
        self.output_file_name = attributes[:'outputFileName']
      end

      if attributes.has_key?(:'outputFileNameIsUnique')
        self.output_file_name_is_unique = attributes[:'outputFileNameIsUnique']
      end

      if attributes.has_key?(:'outputFormat')
        self.output_format = attributes[:'outputFormat']
      end
    ...
    def list_invalid_properties
      ...
      if @data_json.nil?
        invalid_properties.push('invalid value for "data_json", data_json cannot be nil.')
      end

      if @output_file_name.nil?
        invalid_properties.push('invalid value for "output_file_name", output_file_name cannot be nil.')
      end

      if @output_file_name_is_unique.nil?
        invalid_properties.push('invalid value for "output_file_name_is_unique", output_file_name_is_unique cannot be nil.')
      end
    ...
    def valid?
      return false if @data_json.nil?
      return false if @output_file_name.nil?
      return false if @output_file_name_is_unique.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          output_file_name_is_unique == o.output_file_name_is_unique &&
    ...
    def hash
      [data_json, output_file_name, output_file_name_is_unique, output_format, template_id].hash
    end
