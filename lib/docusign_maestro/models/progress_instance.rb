...
module DocuSign_Maestro
  ...
  class ProgressInstance
    ...
    attr_accessor :current_completed_step_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'completedSteps')
        self.completed_steps = attributes[:'completedSteps']
      end

      if attributes.has_key?(:'currentCompletedStepName')
        self.current_completed_step_name = attributes[:'currentCompletedStepName']
      end

      if attributes.has_key?(:'totalSteps')
        self.total_steps = attributes[:'totalSteps']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          current_completed_step_name == o.current_completed_step_name &&
