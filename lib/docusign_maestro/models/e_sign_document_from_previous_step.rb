...
module DocuSign_Maestro
  class ESignDocumentFromPreviousStep
    ...
    attr_accessor :document_from_previous_step
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'documentFromPreviousStep')
        self.document_from_previous_step = attributes[:'documentFromPreviousStep']
      end
    ...
    def list_invalid_properties
      ...
      if @document_from_previous_step.nil?
        invalid_properties.push('invalid value for "document_from_previous_step", document_from_previous_step cannot be nil.')
      end
    ...
    def valid?
      return false if @document_from_previous_step.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          document_from_previous_step == o.document_from_previous_step &&
    ...
    def hash
      [document_from_previous_step, file_extension, name, type].hash
    end
