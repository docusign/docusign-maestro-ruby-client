...
module DocuSign_Maestro
  ...
  class WorkflowDefinitionWithId
    ...
    attr_accessor :last_deployed_workflow_definition
    ...
    def hash
      [account_id, created_date, id, is_draft, last_deployed_id, last_deployed_version, last_deployed_workflow_definition, last_updated_date, status, trigger_url, validation_errors, workflow_definition].hash
    end
